...
<div class="container bo">
    ...
    <div class="row justify-content-center mt-4">
		...
		<div class="search-container mt-4">
		       ...
		       <c:choose>
			<c:when test='${listUsingGym == null or empty listUsingGym}'>
				<td colspan="4">
					<p align="center">
						<b><span style=''>헬스장 이용내역이 없습니다.</span></b>
					</p>
				</td>
			</c:when>

			<c:when test="${listUsingGym != null }">
            ...
            <div class="col-md-5 mb-3">
                <div class="card h-100 p-4 bg-gray-100 rounded-lg shadow-md" onclick="location.href='gymPostDetail?g_id=${board.g_id}'">
                    ...
                    <div class="card-body">
                        ...
                        <p class="stars text-yellow-500" style="margin-top: -10px;"><i class="fa-solid fa-dumbbell" style="color: #4682B4;"></i>
	        ...
	        <nav aria-label="페이지 네비게이션">
	            <ul class="pagination justify-content-center">
	            	...
	            	<button type="button" class="btn btn-outline-secondary" 
						onclick="location.href='hsRefundFormUsingGym?m_number=${m_number}'">환불하기</button>
            		</li>
	            </ul>
