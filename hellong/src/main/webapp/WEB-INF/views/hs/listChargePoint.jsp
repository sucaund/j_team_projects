...
<%-- 	<form action="hsCondListPoint?m_number=${memberData.m_number }" method="post">
	...
	<c:if test="${page.startPage > page.pageBlock }">
		<a href="hsListChargePoint?currentPage=${page.startPage-page.pageBlock}&m_number=${memberData.m_number}">[이전]</a>
	</c:if>
	<c:forEach var="i" begin="${page.startPage}" end="${page.endPage}">
		<a href="hsListChargePoint?currentPage=${i}&m_number=${memberData.m_number}">[${i}]</a>
	</c:forEach>
	<c:if test="${page.endPage < page.totalPage }">
		<a href="hsListChargePoint?currentPage=${page.startPage+page.pageBlock}&m_number=${memberData.m_number}">[다음]</a>
	</c:if>	
