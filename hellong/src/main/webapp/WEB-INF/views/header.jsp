			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-3 col-md-3 col-7">
						<!-- Start Header Logo -->
						<a class="navbar-brand" href="Default"> <img
						...
						<div class="middle-right-area">
							<div class="nav-hotline">
								<h3>
									...
									%>
									<span><a href="jmMyPage">${sessionScope.m_name}님</a>,
										안녕하세요</span> <a href="jmLogOut">로그아웃</a>
									<%
									} else {
									%>
									<a href="jmLoginForm">로그인</a> &nbsp; &nbsp; <a
										href="jmSignUpFormAjax2">회원가입</a>
									<%
									}
									%>
								</h3>
					...
					<div class="nav-inner">
						...
						<div class="mega-category-menu">
							...
							<ul class="sub-category">
								<li><a href="/GymPostList">헬스장(지점찾기)</i></a></li>
								<li><a href="/communityBoard">자유게시판</a></li>
								<li><a href="/listBodyProfile">바디프로필</a></li>
								<li><a href="/jmMyPage">마이페이지</a></li>
								<li><a
									href="https://demo.graygrids.com/themes/shopgrids/product-grids.html">작성글</a></li>
								<li><a
									href="https://demo.graygrids.com/themes/shopgrids/product-grids.html">결제</a></li>
								<li><a href="/jmUpdateMemberForm">개인정보수정</a></li>
								<li><a
									href="/listGymManager">비즈니스
										개설/관리</a></li>
								<li><a href="/GymPostList">헬스장(지점찾기)</a></li>
								<li><a href="/communityBoard">고객센터
						...
						<nav class="navbar navbar-expand-lg">
							...
							<div class="collapse navbar-collapse sub-menu-bar"
								...
								<ul id="nav" class="navbar-nav ms-auto">
									<li class="nav-item"><a href="Default" class="active"
										aria-label="Toggle navigation">홈</a></li>
									<li class="nav-item"><a href="/GymPostList"
										aria-label="Toggle navigation">헬스장(지점찾기)</a></li>
									...
									<li class="nav-item"><a class="dd-menu collapsed"
										...
										aria-controls="navbarSupportedContent" aria-expanded="false"
										aria-label="Toggle navigation">내 정보</a>
										<ul class="sub-menu collapse" id="submenu-1-4">
											<li class="nav-item"><a href="/jmMyPage">마이페이지</a></li>
											<li class="nav-item"><a href="blog-grid-sidebar.html">작성글</a></li>
											<li class="nav-item"><a
												href="https://demo.graygrids.com/themes/shopgrids/blog-single-sidebar.html">결제</a></li>
											<li class="nav-item"><a href="/jmUpdateMemberForm">개인정보수정</a></li>

										</ul></li>

									<li class="nav-item"><a
										href="https://demo.graygrids.com/themes/shopgrids/contact.html"
